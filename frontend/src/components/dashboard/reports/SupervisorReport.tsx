  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl text-black font-bold">My Attendance Report</h1>
        <button
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg shadow-md mb-6 overflow-x-auto border border-blue-200">
        <div className="px-6 py-4 border-b border-blue-200 bg-white/50">
          <h2 className="text-lg font-bold text-blue-900">Supervisor Information</h2>
        </div>
        <table className="w-full">
          <tbody>
            <tr className="border-b border-blue-100 bg-white/30">
              <td className="px-6 py-3 text-sm font-semibold text-blue-900 w-1/4">Supervisor Name</td>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 mt-6">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">Team Members Reports</h2>
          <p className="text-sm text-gray-500 mt-1">View attendance reports for your team members</p>
        </div>
        <div className="max-h-96 overflow-y-auto divide-y divide-gray-100">
          {teamMembers.length === 0 ? (
            ...
            teamMembers.map((member) => (
              <div key={member.id} className="px-6 py-4 hover:bg-gray-50 transition-colors flex items-center justify-between group">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3 mt-0.5">
                      <p className="text-sm text-gray-600">{member.jobTitle || 'Employee'}</p>
                      <span className="text-gray-300">•</span>
                      <p className="text-sm text-gray-500">ID: {member.numericId}</p>
                    </div>
                  </div>
                </div>
                <button
